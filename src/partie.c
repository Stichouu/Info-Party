...
* \author Tan Tony
* \version 3.0
* \brief Le déroulement d'une partie de notre jeu
*/

/**
* \fn void trie(int * t,int n)
* \param t Pointeur sur un objet de type integer
* \param n Objet de type integer
* \brief La fonction permet de trier dans l'ordre décroissant (trie bulle) notre pointeur t.
*/
...
/**
* \fn void ordre_jeu()
* \brief La fonction va définir l'ordre de jeu en début de partie.
*/
void ordre_jeu(){
...
/**
* \fn void une_partie(SDL_Window *fenetre,SDL_Renderer * rendu,SDL_Rect cases[NB_CASE],int liste_case[NB_CASE],int nb_tours,int nb_joueurs)
...
* \param nb_tours Objet de type integer 
* \param nb_joueurs Objet de type integer 
* \brief la fonction va démarrer une partie en prenant le nombre de tours et de joueurs en paramètre en appellant plusieurs fonctions.
*/
