...
* \author Tony Tan
* \version 4.0
* \brief Le création d'une partie de notre jeu
*/


/**
* \fn void creation_partie(SDL_Window *fenetre,int * joueur, int * tour,int * quitter)
...
* \brief la fonction permettant d'afficher notre création de partie ainsi que la gestion du nombre de joueurs et tours en cliquant sur les cases dédiées.
*/
